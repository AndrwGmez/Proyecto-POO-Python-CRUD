...
class Productos():
	...
	def __init__(self, ventana_producto):	
		...
		ventana_producto.iconbitmap("C:/Users/jhefe/Downloads/SENA ADSO 2022/Trimestre 5/YULY/Interfaz/Forms - Data Base/9/calcu.ico")
		...
		self.img_registrar = PhotoImage(file="C:/Users/jhefe/Downloads/SENA ADSO 2022/Trimestre 5/YULY/Interfaz/Forms - Data Base/9/fondos/corriendo.png")
		self.img_buscar = PhotoImage(file="C:/Users/jhefe/Downloads/SENA ADSO 2022/Trimestre 5/YULY/Interfaz/Forms - Data Base/9/fondos/revista.png")
		self.img_informacion = PhotoImage(file="C:/Users/jhefe/Downloads/SENA ADSO 2022/Trimestre 5/YULY/Interfaz/Forms - Data Base/9/fondos/mundial.png")
		...
		self.frame_registro = LabelFrame(ventana_producto, text="Informacion del producto", font=("Comic Sans MS", 10, "bold"), pady=5)
		...
		self.frame_buscar_producto = LabelFrame(ventana_producto, text="Buscar producto", font=("Comic Sans MS", 10, "bold"), pady=5)
		...
		titulo = Label(self.frame_registro, text="LISTA DE PRODUCTOS", fg="black", font=("Comic Sans MS", 13, "bold"), pady=5)#.pack()


		imagen_1 = Image.open("C:/Users/jhefe/Downloads/SENA ADSO 2022/Trimestre 5/YULY/Interfaz/Forms - Data Base/9/fondos/mundial.png")
		...
		imagen_2 = Image.open("C:/Users/jhefe/Downloads/SENA ADSO 2022/Trimestre 5/YULY/Interfaz/Forms - Data Base/9/fondos/revista.png")
		...
		imagen_3 = Image.open("C:/Users/jhefe/Downloads/SENA ADSO 2022/Trimestre 5/YULY/Interfaz/Forms - Data Base/9/fondos/dieta.png")
		...
		imagen_4 = Image.open("C:/Users/jhefe/Downloads/SENA ADSO 2022/Trimestre 5/YULY/Interfaz/Forms - Data Base/9/fondos/corriendo.png")
		...
		marco_producto = LabelFrame(ventana_producto, text="Informacion de los productos", font=("Comic Sans MS", 13, "bold"), bd=5, pady=5)



		label_codigo_producto = Label(self.frame_registro, text="Código de producto: ", font=("Comic Sans MS", 10, "bold")).grid(row=0, column=0, sticky='s', padx=3, pady=3)
		...
		label_categoria_producto = Label(self.frame_registro, text="Categoria del producto: ", font=("Comic Sans MS", 10, "bold")).grid(row=0, column=3, sticky='s', padx=3, pady=3)
		self.categoria_producto = ttk.Combobox(self.frame_registro, values=["Gamer", "Computadores", "Audifonos", "Accesorios", "Electrodomesticos", "Automoviles", "Motocicletas", "Otro"], width=17, state="readonly")
	...
	def agregar_producto(self):
		if self.validar_formulario_completo() and self.validar_registrar():
			...
			messagebox.showinfo("REGISTRO EXITOSO", f"Producto resgistrado")
	...
	def editar_producto(self):
		...
		descripcion = self.tree.item(self.tree.selection())['values'][2]
		...
		nueva_descripcion = Entry(self.ventana_editar, textvariable=StringVar(self.ventana_editar, value=cantidad), width=25)
		...
		nueva_cantidad = Entry(self.ventana_editar, textvariable=StringVar(self.ventana_editar, value=descripcion), width=25)
	...
	def actualizar(self, nuevo_codigo, nuevo_nombre, nuevo_combo_categoria, nuevo_descripcion, nuevo_cantidad, nuevo_precio, codigo):
		query = 'UPDATE Productos SET codigo=?, nombre=?, categoria=?, descripcion=?,  cantidad=?, precio=? WHERE codigo=?'
	...
	def widgets_buscador(self):
		...
		self.titulo_buscador = Label(self.label_titulo_buscador, text="BUSCADOR DE PRODUCTOS", fg="black", font=("Comic Sans MS", 17, "bold"))
	...
	def widgets_informacion(self):
		...
		imagen_soporte = Image.open("C:/Users/jhefe/Downloads/SENA ADSO 2022/Trimestre 5/YULY/Interfaz/Forms - Data Base/9/fondos/mundial.png")
...
if __name__ == '__main__':
	ventana_producto = Tk()
	applicacion = Productos(ventana_producto)
